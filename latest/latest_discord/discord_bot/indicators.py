...
class Indicators:
    ...
    def start(self):
        ...
        print("😴  Discord sleep ...", self.discord_sleep , +'s')
...
timeframe = input()
print('input discord_sleep:')
discord_sleep = float(input())
while True:
    if __name__ == '__main__':
        ...
        indicators = ['RSI_over', 'RSI_div' 'MACD', 'EMA']#'ADX', 'AROON', 'STOCHRSI', 'WILLR', 'OBV', 'BBANDS', 'ATR', 'TRANGE'
